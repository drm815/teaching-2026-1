        ...
        <div className="max-w-4xl mx-auto p-4 md:p-8 min-h-[70vh] flex flex-col">
            ...
            <div className="mb-8 flex items-center justify-between">
                ...
                <div className="text-right">
                    <span className="text-slate-500 text-sm font-mono">{currentPage + 1} / {totalPages}</span>
            ...
            <div className="mt-8 flex justify-between">
                <button
                    ...
                    className="flex items-center gap-2 px-6 py-2 rounded-xl border border-tech-border/30 text-slate-400 hover:text-white hover:bg-white/5 disabled:opacity-30 disabled:hover:bg-transparent transition-all"
                >
                    <ChevronLeft size={20} />
                    이전
                </button>
                {currentPage < totalPages - 1 && (
                    <button
                        onClick={nextPage}
                        className="flex items-center gap-2 px-6 py-3 rounded-xl bg-tech-primary text-tech-bg font-bold hover:blue-glow transition-all"
                    >
                        다음
